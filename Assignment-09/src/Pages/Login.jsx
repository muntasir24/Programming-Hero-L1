...
const Login = () => {
  ...
  {/* <div>errrr</div> */}
      ...
      <form  className='space-y-5'>
          ...
          <input type="password" className="input focus:ring-0 outline-0 focus:border-violet-500 w-full h-14 px-4" placeholder="Password" />
      ...
      {/* other login  */}
       ...
       <button className="btn w-full  bg-violet-50 text-black border border-violet-400">
